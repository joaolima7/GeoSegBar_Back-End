...
public class InstrumentGraphPatternFolder {
    ...
    @JsonIgnoreProperties({"folder", "instrument", "axes", "properties"})
    private Set<InstrumentGraphPatternEntity> patterns = new HashSet<>();
}
