...
@Entity
@Table(name = "constant", indexes = {
    @Index(name = "idx_constant_instrument_id", columnList = "instrument_id"),
    @Index(name = "idx_constant_acronym", columnList = "acronym"),
    @Index(name = "idx_constant_instrument_acronym", columnList = "instrument_id, acronym")
})
@Getter
@Setter
@NoArgsConstructor
